...
<body>
	...
	<table width="100%" class="list_table1" cellpadding="3">
	    <tr valign="top">
	    	<td width="100%" colspan="6" style="font-size:14" align="center"><u>BUKTI PERTANGGUNJAWABAN KAS</u></td>
	    </tr>
	    <tr valign="top">
	    ...
	    <tr valign="top">
	    	...
	    	<td width="1%">:</td>
	    	<td width="35%">
	    	%if adv.cash_advance_id.payment_adm == 'cash':
	    	Cash
	    	%elif adv.cash_advance_id.payment_adm == 'free_transfer':
	    	Non Payment Administration Transfer
	    	%elif adv.cash_advance_id.payment_adm == 'transfer':
	    	Transfer
	    	%elif adv.cash_advance_id.payment_adm == 'cheque':
	    	Cheque No. ${ adv.cash_advance_id.cheque_number or ''}
	    	%else:
	    	-
	    	%endif
	    	</td>
