...
class general_ledger_inh(report_sxw.rml_parse, common_report_header):
    _inherit = 'report.account.general.ledger'

    def set_context(self, objects, data, ids, report_type=None):
        #print 'vvvvvvvvvvvvccccccccccccc',objects, data, ids, report_type
        new_ids = ids
        ...
        return super(general_ledger_inh, self).set_context(objects, data, new_ids, report_type=report_type)

    def __init__(self, cr, uid, name, context=None):
        if context is None:
            context = {}
        super(general_ledger_inh, self).__init__(cr, uid, name, context=context)
        self.query = ""
        ...
        self.localcontext.update( {
            ...
            'get_account_filter':self.get_account_filter,
        })
    ...
    def get_children_accounts(self, account):
        res = []
        account = self.pool.get('account.account').browse(self.cr, self.uid, self.context['filter_account'])
...
class report_generalledger(osv.AbstractModel):
    ...
    _wrapped_report_class = general_ledger_inh
