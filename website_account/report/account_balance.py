...
class account_balance_inh(report_sxw.rml_parse, common_report_header):
    ...
    def __init__(self, cr, uid, name, context=None):
        ...
        self.localcontext.update({
            ...
            'get_lines_report_trail_balance': self.get_lines_report_trail_balance,
            'get_dates_string':self.get_dates_string,
        })
        self.context = context
     
    def get_title(self):
        return self.pool.get('account.account').title_tb
    
    def get_filter_str(self):    
        return self.pool.get('account.account').filter_str_tb
        
    def get_lines_report_trail_balance(self, data):
        datas = self.pool.get('account.account').get_lines_trail_balance(self.cr, self.uid, data)
        return datas
