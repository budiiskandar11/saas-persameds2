...

{
    ...
    Zesty Beanz Technologies Pvt Ltd added some bug fix for passing properties, subreport without xpath etc
    * Added times new roman font support
    ''', 
    "author" : "NaN·tic, Serpent CS, Zesty Beanz",
    "website" : "http://www.nan-tic.com, http://www.zbeanztech.com",
    'images' : [
