...
<html>
	...
	<body>
		%for o in get_object(data):
			...
			<table width="100%">
				<tr>
					<td class="center bold">REKAPITULASI JAM & UPAH LEMBUR KARYAWAN OUTSOURCING</td>
				</tr>
				<tr>
				...
				<tr>
					<br/><br/><br/>
					<td class="center bold">Beban Anggaran Dept. SDM & Umum</td>
				</tr>
				<tr>
					<td>
						<table class="data">
					...
					%for e in o.outsource:
						...
						%endif
								...
								<td class="padded">${e.name.title()}</td>
