...
class hr_dplk(osv.osv):
    ...
    def _calculate(self, cr, uid, ids, field_names, arg, context=None):
        ...
        for rs in self.browse(cr, uid, ids, context=context):
            ...
            total_umr = 0.0
            if rs.dplk:
                dplk_amount     = (contract.wage)*0.1
                dplk_by_employee= (contract.wage)*0.025
                dplk_by_company = (contract.wage)*0.075
    ...
    _columns = {
                ...
                'contract_wage' : fields.function(_calculate, method=True, store=False, multi='dc', string='Wage', digits_compute=dp.get_precision('Account')),
