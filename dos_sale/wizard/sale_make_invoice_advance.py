...
class sale_advance_payment_inv(osv.osv_memory):
    ...
    _description = "Sales Advance Payment Invoices"
    _columns = {
    ...
    def _prepare_advance_invoice_vals(self, cr, uid, ids, context=None):
        ...
        for sale in sale_obj.browse(cr, uid, sale_ids, context=context):
            ...
            if wizard.advance_payment_method == 'percentage':
                ...
                if not res.get('name'):
                   # des = wizard.description + str(wizard.amount) + '%'
                    #res['name'] = des
            ...
            # create the invoice
            inv_line_values = {
                #'name': sale.description or '/' ,              
                'name': res.get('name') + '' + wizard.description,
                'origin': sale.name,
